                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6 col-adj">
                                <div className="list-group">
                                    ...
                                    <a href={require("../../Assets/bootcampCert.jpeg")} className="list-group-item list-group-item-action" target="_blank"> <img src="https://www.pngfind.com/pngs/m/507-5072232_certification-icon-hd-png-download.png" alt="bootcamp certification icon" className="resume img-fluid"></img>Coding Bootcamp</a>
                                    <a href={require("../../Assets/Modern React Bootcamp.pdf")} className="list-group-item list-group-item-action" target="_blank"> <img src="https://www.pngfind.com/pngs/m/507-5072232_certification-icon-hd-png-download.png" alt="Udemy certification icon" className="resume img-fluid"></img>React Bootcamp</a>
                                    <a href={require("../../Assets/Data Structure and Algorithms Masterclass.pdf")} className="list-group-item list-group-item-action" target="_blank"> <img src="https://www.pngfind.com/pngs/m/507-5072232_certification-icon-hd-png-download.png" alt="Udemy certification icon" className="resume img-fluid"></img>Algorithms Course</a>
                                </div>
                            </div>
                        </div>
                    </div>
