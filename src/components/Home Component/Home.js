                        ...
                        <div className="row">
                            <div className="col-md-6 col-adj">
                                <div className="list-group">
                                    <a href={require("../../Assets/Zachary Deacon Resume V2.pdf")} className="list-group-item list-group-item-action" target="_blank"> <img src="https://www.freeiconspng.com/uploads/resume-icon-png-1.png" alt="resume icon" className="resume"></img> Resume</a>
                                    <a href={require("../../Assets/Letters of Reccomendation.pdf")} className="list-group-item list-group-item-action" target="_blank"> <img src="https://cdn3.iconfinder.com/data/icons/management-and-achivement/100/business_achivement_management-08-512.png" alt="Letters of reference" className="reference"></img> Reference</a>
                                    <a href="https://www.linkedin.com/in/zachary-deacon/" className="list-group-item list-group-item-action" target="_blank"> <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e9/Linkedin_icon.svg/1024px-Linkedin_icon.svg.png" alt="LinkedIn" className="linkedin"></img> LinkedIn</a>
                                    <a href="https://github.com/zackdeacon" className="list-group-item list-group-item-action" target="_blank"> <img src="https://cdn3.iconfinder.com/data/icons/social-media-and-logos-brush/32/github_social_media_logo-512.png" alt="Github" className="github"></img> Github</a>
                                    <a href="https://www.instagram.com/zackdeacon/" className="list-group-item list-group-item-action" tabIndex="-1" aria-disabled="true" target="_blank"> <img src="https://instagram-brand.com/wp-content/uploads/2016/11/Instagram_AppIcon_Aug2017.png?w=300" alt="instagram icon" className="insta"></img> Instagram</a>
                                </div>
                            </div>
                            <div className="col-md-6 col-adj">
                                <div className="list-group">
                                    <a href={require("../../Assets/Yellow belt certificate .pdf")} className="list-group-item list-group-item-action" target="_blank"> <img src="https://www.pngfind.com/pngs/m/507-5072232_certification-icon-hd-png-download.png" alt="resume icon" className="resume"></img>Lean Six Sigma</a>
                                    <a href={require("../../Assets/Google IT Cert.pdf")} className="list-group-item list-group-item-action" target="_blank"> <img src="https://www.pngfind.com/pngs/m/507-5072232_certification-icon-hd-png-download.png" alt="Letters of reference" className="reference"></img> Google IT</a>
                                    <a href={require("../../Assets/situational leadership certification.pdf")} className="list-group-item list-group-item-action" target="_blank"> <img src="https://www.pngfind.com/pngs/m/507-5072232_certification-icon-hd-png-download.png" alt="LinkedIn" className="linkedin"></img> Ken Blanchard</a>
                                </div>
                            </div>
                        </div>
                    </div>
