        ...
        <div class="row row-cols-1 row-cols-md-3">
              ...
              <div class="card card-p">
                <h5 class="card-header">MixMe app!</h5>
                  <a href="https://vinavarghese.github.io/ProjectMixMe/" target="_blank">
                    <img src={require("../../Assets/MixMe2.jpeg")} class="card-img-top project-card-pic picSize" alt="Project link"></img>
                    </a>
            ...
            <div class="col-sm-5">
              <div class="card card-p">
                ...
                <img src={require("../../Assets/PureCloud.jpeg")} class="card-img-top project-card-pic picSize" alt="PureCloud app link"></img>
                </a>
                <div class="card-footer card-footer-height">
            ...
            <div class="col-sm-5">
              <div class="card card-p">
                ...
                <img src={require("../../Assets/Quiz2.jpeg")} class="card-img-top project-card-pic picSize" alt="Quiz app"></img>
                </a>               
                <div class="card-footer card-footer-height">
            ...
            <div class="col-sm-5">
              <div class="card card-p">
                ...
                <img src={require("../../Assets/WeatherApp2.jpeg")} class="card-img-top project-card-pic picSize" alt="weather app link"></img>
                </a>
                <div class="card-footer card-footer-height">
            ...
            <div class="col-sm-5">
              <div class="card card-p">
                ...
                <img src={require("../../Assets/react-employee-directory.jpeg")} class="card-img-top project-card-pic picSize" alt="employee directory app link"></img>
                </a>
                <div class="card-footer card-footer-height">
